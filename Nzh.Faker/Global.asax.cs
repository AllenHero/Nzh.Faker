...
namespace Nzh.Faker
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        private static void SetupResolveRules(ContainerBuilder builder)
        {
            ...
            var iServices = Assembly.Load("Nzh.Faker.IService");
            var services = Assembly.Load("Nzh.Faker.Service");
            var iRepository = Assembly.Load("Nzh.Faker.IRepository");
            var repository = Assembly.Load("Nzh.Faker.Repository");
